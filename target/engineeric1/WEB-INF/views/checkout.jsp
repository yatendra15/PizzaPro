...
<div class="row">
	...
	<table>
		...
		<td><span class="col-lg-15" style="color:Green;align:Right";><label>Grand Total :</label><c:out value=" ${gtot }"></c:out></span></td>
		 </div>
	
		
		<tr>
		<td colspan="1">Name:</td><td>${user.name }</td>
		</tr>
		<tr>
		<td colspan="1">Email:</td><td> ${user.email }</td>
		</tr>
		<tr>
		<td colspan="1">Address:</td><td> ${user.address }</td>
		</tr>
		<tr>
		<td colspan="1">Phone:</td><td> ${user.phone }</td>
		</tr>
